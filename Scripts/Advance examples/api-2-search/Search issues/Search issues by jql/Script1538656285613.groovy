...
def issues_by_jql = WS.sendRequest(findTestObject('Advance examples/api-2-search/Search issues/Search issues by jql', 
...
def issue_by_jql_issue_key = WS.sendRequest(findTestObject('Advance examples/api-2-search/Search issues/Search issues by issue_key', 
	[('authorization') : GlobalVariable.authorization
            , ('issue_key') : 'KD-1000']))
