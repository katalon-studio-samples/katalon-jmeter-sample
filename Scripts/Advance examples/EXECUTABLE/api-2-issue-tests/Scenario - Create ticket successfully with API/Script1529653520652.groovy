...
WebUI.callTestCase(findTestCase('Advance examples/DO NOT RUN/api-2-issue/Create issue/The API is called successfully and new issue is created'), [('response') : response], 
    FailureHandling.STOP_ON_FAILURE)
